---
title: "Impact of intraspecific genetic variability on interspecific competition:
  a theorical case study on binary mixtures"
author: "Béatrice WOLFF, Bernadette JULIER & Gaëtan LOUARN"
date: "21/09/2022"
...
#dtoto
dat2 <- read.table(paste0(here::here(),"/","tabletoto_corr.csv"), header=T, sep=";", dec=".")
...
Dynamic figures for article doi.... 



```{r  echo=FALSE}

# gestion du panneau options dynamiques
inputPanel(
  selectInput("traitN", label = "Environment:", 
              choices = ls_mng, selected = "N+"),
...
tabsetPanel(type = "tabs",
                  ...
                  tabPanel("B) Yield", plotOutput("res_plot1"), textOutput("res_text1"), style='width: 1000px; height: 700px'),
                  tabPanel("C) Sp. proportion", plotOutput("res_plot2"), textOutput("res_text2"), style='width: 1000px; height: 700px'),
                  tabPanel("D) Gini", plotOutput("res_plot3"), textOutput("res_text3"), style='width: 1000px; height: 700px'),
                  tabPanel("E) D5param", plotOutput("res_plot4"), textOutput("res_text4"), style='width: 1000px; height: 700px'),
                  tabPanel("F) DM correlations", plotOutput("res_plot5"), textOutput("res_text5"), style='width: 1000px; height: 700px'),
                  tabPanel("G) CE-SE", plotOutput("res_plot7"), textOutput("res_text7"), style='width: 1000px; height: 700px'),
