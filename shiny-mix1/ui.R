...
shinyUI(
    ...
    sidebarLayout(
        ...
        tabsetPanel(type = "tabs",id = "tabset",
                    ...
                    tabPanel("D) Overyielding", plotOutput("res_plot2"), textOutput("res_text2")),
                    tabPanel("E) Resource use", plotOutput("res_plot3"), textOutput("res_text5")),
                    tabPanel("F) CE-SE", plotOutput("res_plot4"), textOutput("res_text3")),
                    
                    tabPanel("G) Traits", fluidRow(column(6,imageOutput("img_Len")),
